    ...
    <div className="border border-[#2A2A2A] rounded-lg overflow-hidden">
      ...
      {open && (
        <div className="px-4 py-3 bg-[#0D0D0D] space-y-4 text-xs">
          <div>
            <div className="text-[10px] text-[#404040] uppercase tracking-wider mb-2">Fortalezas</div>
          ...
          <div>
            <div className="text-[10px] text-[#404040] uppercase tracking-wider mb-2">Goles Esperados</div>
            <Row label="λ Local" value={trace.lambdaHome.toFixed(4)} />
            <Row label="λ Visitante" value={trace.lambdaAway.toFixed(4)} />
          </div>
          <div>
            <div className="text-[10px] text-[#404040] uppercase tracking-wider mb-2">Probabilidades del Modelo</div>
          ...
          <div>
            <div className="text-[10px] text-[#404040] uppercase tracking-wider mb-2">Fuentes</div>
