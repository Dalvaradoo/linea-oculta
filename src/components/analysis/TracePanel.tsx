  ...
  return (
    <div className="border border-[#2A2A2A] rounded-lg overflow-hidden">
      <button
        ...
        aria-expanded={open}
      >
        <span className="text-[11px] font-mono text-[#787878] uppercase tracking-widest">
          Trace — {selection}
        </span>
      ...
      {open && (
        <div className="px-4 py-3 bg-[#0D0D0D] space-y-4 text-xs">
          <div>
            <div className="text-[11px] text-[#404040] uppercase tracking-wider mb-2">Fortalezas</div>
          ...
          <div>
            <div className="text-[11px] text-[#404040] uppercase tracking-wider mb-2">Fuentes</div>
